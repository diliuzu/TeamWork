...
### Bug fixes ###
 ...
 - Listen for mouseleave events and fire a plothover event with empty
   tbItem when it occurs to drop highlights when the mouse leaves the
 ...
 - Fix bug in picking tbItems when transform/inverseTransform is in use
...
event now returns the closest data tbItem (based on patch by /david, patch by
...
## Bug fixes ##
 ...
 - Fixed a bug in handling single-tbItem bar series. (reported by Emil Filipov)
