                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table id="treeTable" class="table table-hover">
                                ...
                                <tbody>
                                <c:forEach items="${ListItemCats}" var="itemCat">
                                    <tr id="${itemCat.id}" pId="${itemCat.parent.id}">
                                        <td>${itemCat.id}</td>
                                        <td>${itemCat.name}</td>
                                        <td>${itemCat.sortOrder}</td>
                                        <td>${itemCat.created}</td>
                                        <td>
                                            <a type="button" href="/itemCat/form?parent.id=${itemCat.id}&parent.name=${category.name}" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> 创建下一级目录</a>
                                            <a type="button" href="/itemCat/form?id=${itemCat.id}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>
                                            <a type="button" href="/itemCat/deleteById?id=${itemCat.id}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> 删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
