                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="padding-left: 25px">
                                ...
                                <a type="button" onclick="App.deleteItem('/content/delSelect')" class="btn btn-sm btn-default"><i class="fa fa-trash"></i> 删除</a>&nbsp;&nbsp;
                        ...
                        <div class="row" style="padding-top: 10px">
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input cssClass="form-control" id="title" placeholder="标题"/>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="subTitle" cssClass="form-control" placeholder="子标题"/>
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="titleDesc" cssClass="form-control" placeholder="标题描述"/>
...
<script>
    var url ="/content/selectPageContent";
    ...
    var columns=[
        ...
        {
            "data": function (row, type, val, meta) {
                return '<button type="button" onclick="App.showDetails(\'/content/details?id='+row.id+'\')" class="btn btn-sm btn-default"><i class="fa fa-search"></i>查看</button>' +
                    '<a type="button" href="/content/form?id='+row.id+'" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>编辑</a>' +
                    '<a type="button" href="/content/deleteById?id='+row.id+'" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>删除</a>'
            }
        }
    ];
