...
* [#16804](https://dev.ckeditor.com/ticket/16804): Fixed: Focus is not on the first menu tbItem when the user opens a context menu or a drop-down list from the editor toolbar.
...
* [#16745](https://dev.ckeditor.com/ticket/16745): [Edge] Fixed: List tbItems are lost when [pasted from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* [#10373](https://dev.ckeditor.com/ticket/10373): Fixed: Context menu tbItems can be dragged into the editor.
...
* [#14755](https://dev.ckeditor.com/ticket/14755): [Blink, WebKit, IE8] Fixed: Browser hangs when a table is inserted in the place of a selected list with an empty last tbItem.
...
* [#7807](https://dev.ckeditor.com/ticket/7807): Fixed: Last tbItem in a list not converted to a `<li>` element after [pasting from Word](https://ckeditor.com/cke4/addon/pastefromword).
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).
  ...
  * Browser support.<br>Browser support for related features varies significantly (see http://caniuse.com/clipboard).
    ...
    * Only Chrome and Safari on Mac OS support setting custom data tbItems in the clipboard, so currently it is possible to recognize the origin of the copied content in these browsers only. All drag and drop operations can be identified thanks to the new Data Transfer facade.
...
* [#12729](https://dev.ckeditor.com/ticket/12729): Fixed: Incorrect structure created when merging a block into a list tbItem on *Backspace* and *Delete*.
...
* [#12141](https://dev.ckeditor.com/ticket/12141): Fixed: List tbItems are lost when indenting a list tbItem with content wrapped with a block element.
...
* [#11897](https://dev.ckeditor.com/ticket/11897): Fixed: *Enter* key used in an empty list tbItem creates a new line instead of breaking the list. Thanks to [noam-si](https://github.com/noam-si)!
...
* [#11574](https://dev.ckeditor.com/ticket/11574): Fixed: *Backspace* destroying the DOM structure if an inline editable is placed in a list tbItem.
...
* [#10890](https://dev.ckeditor.com/ticket/10890): Fixed: Error thrown when pressing the *Delete* key in a list tbItem.
...
* [#11125](https://dev.ckeditor.com/ticket/11125): Fixed: Keyboard navigation through menu and drop-down tbItems will now cycle.
...
* [#9829](https://dev.ckeditor.com/ticket/9829): Advanced Content Filter - data and features activation based on editor configuration.
  ...
  * Based on loaded features (toolbar tbItems, plugins) - the data will be filtered according to what the editor in its
  ...
  * Based on [`config.allowedContent`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-allowedContent) rules - the data
  will be filtered and the editor features (toolbar tbItems, commands, keystrokes) will be enabled if they are allowed.
...
* [#10152](https://dev.ckeditor.com/ticket/10152): Fixed: Invalid ARIA property used on menu tbItems.
