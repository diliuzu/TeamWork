...
<script>
    ...
    var columns =[
        ...
        {
            "data": function (row, type, val, meta) {
                return '<button type="button" onclick="App.showDetails(\'/item/details?id='+row.id+'\')" class="btn btn-sm btn-default"><i class="fa fa-search"></i>查看</button>' +
                    '<a type="button" href="/item/form?id='+row.id+'" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>编辑</a>' +
                    '<a type="button" href="/item/deleteById?id='+row.id+'" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>删除</a>'
            }
        }
    ];
